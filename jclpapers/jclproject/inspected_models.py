...
class JclappCart(models.Model):
    quantity = models.IntegerField()
    product = models.ForeignKey('JclappProduct', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'jclapp_cart'


class JclappCustomerprofile(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'jclapp_customerprofile'


class JclappOrder(models.Model):
    ...
    user = models.ForeignKey(JclappCustomerprofile, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'jclapp_order'


class JclappOrderitem(models.Model):
    quantity = models.IntegerField()
    order = models.ForeignKey(JclappOrder, models.DO_NOTHING)
    product = models.ForeignKey('JclappProduct', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'jclapp_orderitem'


class JclappProduct(models.Model):
